...
from model import Users, Profiles, db, ListChapter, ListManga, ReviewsManga
...
app.config["SQLALCHEMY_BINDS"] = {
    ...
    "MANGASYSTEM": "mysql://root:180201Thinh!@localhost/MANGASYSTEM"
}
...
#         profile = Profiles(id_user=find_user.id_user, name_user=find_user.email,
...
#                     identity={"id_user": account.id_user, "email": account.email, "password": account.password})
#                 return jsonify(message="Login successfully",
#                                account={"id_user": account.id_user, "email": account.email,
...
# @app.route('/get_detail_manga', methods=['GET', 'POST'])
# def get_detail_manga():
#     link_manga = request.form.get('link-manga')
#     print(link_manga)
#     manga = ListManga.query.filter_by(id_manga=link_manga).first()
#     print(manga)
#     data = dict()
#     data['descript_manga'] = manga.descript_manga
#     data['list_chapter'] = manga.list_chapter.split(',')
#     review = ReviewsManga.query.filter_by(link_manga=link_manga).All()
#     list_review = []
#     for item in review:
#         data_review = dict()
#         if item.link_user is not None:
#             data_review['link_user'] = item.link_user
#         else:
#             data_review['link_user'] = ''
#         if item.noi_dung is not None:
#             data_review['content'] = item.noi_dung
#
#         data_review['time_review'] = item.time_review
#
#         list_review. append(data_review)
#     print(review)
